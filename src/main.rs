...
async fn main() -> anyhow::Result<()> {
    ...
    println!("{C}│                                                           │{R}");
    println!("{C}├─────────────────────────────────────────────────────────────┤{R}");
    println!("{C}│{R}  {C}{B}NapCat{R}{W}  ws://127.0.0.1:4447                              {C}│{R}");
    println!("{C}│{R}  {C}{B}LLM{R}     {} (9B, :8081)                    {C}│{R}", cfg.llm_model);
    println!("{C}│{R}  {C}{B}Embed{R}  Qwen3.5-0.8B (:8082, CPU)                        {C}│{R}");
    println!("{C}│{R}  {C}{B}Web{R}    http://127.0.0.1:{}                            {C}│{R}", cfg.web_port);
    println!("{C}│{R}  {C}{B}Data{R}   ./data                                           {C}│{R}");
    println!("{C}└─────────────────────────────────────────────────────────────┘{R}");
    println!();
