...
", C=C, R=R);
    print!("{C}  ├───────────────────────────────────────────────────────────┤{R}
", C=C, R=R);
    print!("{C}  │{G}  NapCat{R}  {}                              {C}│{R}
", cfg.napcat_ws_url, C=C, G=G, R=R);
    print!("{C}  │{G}  LLM{R}     {} (9B, :8081)                    {C}│{R}
", cfg.llm_model, C=C, G=G, R=R);
    print!("{C}  │{G}  Embed{R}  Qwen3.5-0.8B (:8082, CPU)                        {C}│{R}
", C=C, G=G, R=R);
    print!("{C}  │{G}  Web{R}    http://127.0.0.1:{}                            {C}│{R}
", cfg.web_port, C=C, G=G, R=R);
    print!("{C}  │{G}  Data{R}   ./data                                           {C}│{R}
", C=C, G=G, R=R);
    print!("{C}  └───────────────────────────────────────────────────────────┘{R}
", C=C, R=R);
    println!();
