...
async fn main() -> anyhow::Result<()> {
    ...
    println!("{D}    ───────────────────────────────────────────────────────{R}", D=D, R=R);
    println!("");
    println!("{C}{B}  NapCat{R}{W}  ws://127.0.0.1:4447{R}", C=C, B=B, R=R, W=W);
    println!("{C}{B}  LLM{R}{W}     Qwen3.5-9B-Q4_K_M (9B, :8081){R}", C=C, B=B, R=R, W=W);
    println!("{C}{B}  Embed{R}{W}   Qwen3.5-0.8B (:8082, CPU){R}", C=C, B=B, R=R, W=W);
    println!("{C}{B}  Web{R}{W}     http://127.0.0.1:5050{R}", C=C, B=B, R=R, W=W);
    println!("{C}{B}  Data{R}{W}    ./data{R}", C=C, B=B, R=R, W=W);
    println!("");
    println!("{D}    ───────────────────────────────────────────────────────{R}", D=D, R=R);
    println!("      {W}v0.1.0{R}", W=W, R=R);
    println!();
