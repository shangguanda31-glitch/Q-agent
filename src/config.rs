...
impl Config {
    pub fn from_env() -> Self {
        ...
        Self {
            ...
            llama_server_path: std::env::var("LLAMA_SERVER_PATH").unwrap_or_else(|_| "D:/llm/llama-bin/llama-server.exe".to_string()),
            llama_model_path: std::env::var("LLAMA_MODEL_PATH").unwrap_or_else(|_| "D:/llm/models/Qwen3.5-9B.Q4_K_M.gguf".to_string()),
            embed_model_path: std::env::var("EMBED_MODEL_PATH").unwrap_or_else(|_| "D:/llm/models/Qwen3.5-0.8B-Q6_K.gguf".to_string()),
            ...
            claude_code_timeout_secs: std::env::var("CLAUDE_CODE_TIMEOUT").ok().and_then(|v| v.parse().ok()).unwrap_or(120),
